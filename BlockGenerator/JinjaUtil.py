...
def render_workspace( xmlpath, jinja_file, additional_args={}, jinja_env=JINJA_ENVIRONMENT):
    ...
    return render_template( jinja_file, jinja_vars, additional_args, jinja_env=jinja_env)

def render_template( jinja_file, jinja_vars, additional_args={},jinja_env=JINJA_ENVIRONMENT ):
    template = jinja_env.get_template(jinja_file)
